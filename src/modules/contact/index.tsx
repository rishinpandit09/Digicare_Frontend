  ...
  return (
    <div className="newChanges Data">
      <div className="container">
        ...
        <p className="text-data">We look forward to hearing from you and discussing how we can support your hospital's digital transformation journey. Thank you for considering MedMasters as your partner in healthcare innovation.</p>
      </div>
    </div>
