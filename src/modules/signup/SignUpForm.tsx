...
import MedMastersAutocomplete from "../common/components/DigicareAutoComplete";
      ...
      >
        <Container component="main" maxWidth="xs">
          ...
          <Box className={classes.signUpFormGrid}>
            ...
            <div className="topicon-medmasters">{View}</div>
            <form onSubmit={handleSubmit} className="medmasters-signup-form">
              <Grid container spacing={2}>
                ...
                {role === EUserRole.doctor && (
                  <>
                    ...
                    <Grid item xs={12}>
                      <MedMastersAutocomplete
                        data={medmastersConfig.specialization}
                    ...
                    <Grid item xs={12}>
                      <MedMastersAutocomplete
                        data={medmastersConfig.study_history}
