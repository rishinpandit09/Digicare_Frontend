...
import { MedMastersTitle } from "../title/title";
...
export function MedMastersDrawer({ children }: DigicareDrawerProps, props) {
      ...
      >
        ...
        >
          ...
          <div className="doctor-details" style={{ textAlign: "center" }}>
            ...
            /> */}
            <img
              src="/digicare-logo.png"
              alt="medmasters-logo"
              className="medmasters-logo"
            />
          </div>
          {drawer}
        </Drawer>
