...
import MedMastersAlertDialog from "../../common/components/MedMastersDialogueBox";
      ...
      return (
        <>
          {Object.keys(data).map((realObjKey) => {
            if (
              Object.keys(medmastersConfig.realtimeUnits).includes(realObjKey)
            ) {
              const dataAsRealTimeRecordProps: RealTimeRecordProps = {
                name: realObjKey,
                reading: data[realObjKey as keyof RealTimeDataProps],
                unit: medmastersConfig.realtimeUnits[realObjKey].unit,
                min_value: medmastersConfig.realtimeUnits[realObjKey].min,
                max_value: medmastersConfig.realtimeUnits[realObjKey].max,
              };
              return (
                <RealTimeRecordCard
          ...
          return (
            ...
            >
              ...
              <DigicareAccordionDetails>
                ...
                <MedMastersIcons
                  iconFor={MedMastersIconEnum.sosCall}
